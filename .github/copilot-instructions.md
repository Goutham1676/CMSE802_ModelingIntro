...
Follow `ai-policy.md` as the canonical source for repository AI philosophy, policy, and quality expectations.

Do not duplicate or fork policy from `ai-policy.md`; update that file instead.
